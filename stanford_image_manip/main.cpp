...
//    cout << "All done, exiting" << endl;
    ...
    //declare une image
   Image iml("res/euromed_image.png");
   Image ims("res/euromed_image.png");
   Image imr("res/euromed_image.png");
  Grayscale Img("res/euromed_image.png");
 // Illini il("res/euromed_image.png");
   iml.lighten(0.4);
   ims.saturate(0.4);
   imr.rotateColor(90);
   Img.Gs();
   iml.writeToFile("res/euromed_lighten.png");
   ims.writeToFile("res/euromed_saturate.png");
   imr.writeToFile("res/euromed_rotation.png");
 // il.writeToFile("res/euromed_illini.png");
   Img.writeToFile("res/euromed_GrayS.png");
